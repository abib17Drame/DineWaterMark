...
export function getRelocatedReviewPresetConfig() {
    return {
        id: 'relocated-review',
        label: 'Traitement IA Auto',
        description: 'Détecte automatiquement le filigrane et utilise l\'IA pour le nettoyer, sans paramétrage manuel.',
...
export function getStandardAutoPresetConfig() {
    return {
        id: 'standard-auto',
        label: 'Traitement IA Auto',
        description: 'Utilise l\'IA pour traiter le filigrane Gemini/Veo en bas à droite.',
        alphaGain: DEFAULT_AUTO_ALPHA_GAIN,
        adaptiveAlpha: false,
        highQualityCleanup: DEFAULT_HIGH_QUALITY_CLEANUP,
